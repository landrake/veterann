                    ...
                    <form class="form-horizontal" method="post" action="#" enctype="multipart/form-data">
                        <div class="form-group form-group-sm" >
                            ...
                            <div class="row">
                                ...
                                <label class="col-sm-4 control-label" for="formGroupInputSmall" style="text-align:left;">L = Laki - laki , P = Perempuan</label>
                                <br><br>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <label class="col-sm-3 control-label" for="formGroupInputSmall" style="text-align:left;">H = Hidup, M = Meninggal</label>
